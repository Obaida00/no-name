...
return [
    ...
    */
    ...
    'prohibited_unless' => ':attribute محظور ما لم :other يكون في :values.',
    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'max' => 'الاسم يجب أن لا يتجاوز :max حرفًا.',
        ],
        'email' => [
            'required' => 'البريد الإلكتروني مطلوب.',
            'email' => 'يجب أن يكون البريد الإلكتروني صحيح البُنية.',
            'unique' => 'البريد الإلكتروني مُستخدم من قبل.',
        ],
        'password' => [
            'required' => 'كلمة المرور مطلوبة.',
            'confirmed' => 'كلمة المرور غير متطابقة مع التأكيد.',
        ],
